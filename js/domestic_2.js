function GetId(id){
	 ...
	 function  GetJson() {
	 	...
	 	for(var i=0;i<40;i++){
	 		var q={
	 			'img':'img/DS_page2/banner_2.jpg',
                'business':'多日游'+i,
                'ProductIntroduction':'<江苏乌镇>领略大自然风情 畅快 5 日游',
                'SurplusGoods':' ¥98',
                'GoodsPrice':'立即购买',
                'place':'火车票 &nbsp;&nbsp;&nbsp;郑州-江苏 乌镇',
                'Thing':'15065 次浏览 1 件 已售',
                'quanguo':'全国多地往返江苏乌镇+杭州9天往返含税车票(可配多地联运)',
                'RGB':'98元起',
                'R':'988元',
                'hre':'——',
     ...
     window.onload=function (){
        ...
        if (Page>=6) {
            GetId('Dg_Click_Event').parentNode.style.width=6*30+'px';
