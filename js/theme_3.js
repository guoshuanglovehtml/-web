function GetId(id){
	 ...
	 function  GetJson() {
	 	...
	 	for(var i=0;i<40;i++){
	 		var q={
                ...
                'business':'多日游'+i,
                'ProductIntroduction':'<澳大利亚>大堡礁 带你领略海底世界',
                'SurplusGoods':' ¥988',
                'GoodsPrice':'立即购买',
                'place':'机票 &nbsp;&nbsp;&nbsp;香港-澳大利亚 堪培拉',
                'Thing':'15065 次浏览 1 件 已售',
                'quanguo':'全国多地往返澳大利亚黄金海岸+凯恩斯9天往返含税机票(香港转机可配多地联运)',
                'RGB':'988元起',
                'R':'1998元',
                'hre':'——',
     ...
     window.onload=function (){
     	(function AddGoods(add){
            ...
            var Img_ = ["img/slice/0.png","img/slice/1.png","img/slice/2.png","img/slice/3.png"];
